 ...
 * =============================================================================
 * أُنشئ تلقائياً عبر create-client.mjs (Client Factory) بتاريخ 2026-08-16T11:08:18.637Z.
 *
...
export const CLIENT = {
  ...
  "defaultCustomerCategory": "عميل جديد",
  "expenseCategories": [
    "عمومية",
    "إيجارات",
    "كهرباء ومرافق",
...
export const FALLBACK_FIREBASE_CONFIG = {
  apiKey:            "AIzaSyDqrgSQrqjvYbAB_dO8U16kLPtgn9CbfAc",
  authDomain:        "el-ragabi-system.firebaseapp.com",
  projectId:         "el-ragabi-system",
  storageBucket:     "el-ragabi-system.firebasestorage.app",
  messagingSenderId: "1009661481326",
  appId:             "1:1009661481326:web:a596522ddb7e6df26a717f",
  measurementId:     "G-RN4XB8L78Z",
}
